...
<div class="min-h-[80dvh] flex items-center justify-center px-4">
    <div class="card max-w-lg w-full text-center p-6 sm:p-10">
        ...
        <p class="text-neutral-600 leading-relaxed mb-8">Akaun anda sudah siap. Cipta chatbot pertama anda dalam kira-kira dua minit.</p>
        <div class="flex flex-col gap-3">
            <a href="{{ route('chatbots.create') }}" class="btn btn-primary justify-center">Cipta chatbot pertama</a>
